...
import GloalStyles from "../globalStyling/GlobalStyles";
...
function ProfileScreen() {
    ...
    * Hvis ikke de valgte fonts er færdigloadet, skal der fremvises et loader symbol, der er importeret fra
    * expo-app-loading
